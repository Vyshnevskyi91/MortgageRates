 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "e81f06c3-727e-4071-8fe2-301a8e80f279",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "DataFrame 'result_df' has been successfully saved to mortgage_rates_files/result_df.xlsx\n",
      "DataFrame 'OurBestMortgageRates' has been successfully saved to mortgage_rates_files/OurBestMortgageRates.xlsx\n",
      "DataFrame 'td_bank' has been successfully saved to mortgage_rates_files/td_bank.xlsx\n",
      "DataFrame 'Bank_of_Montreal' has been successfully saved to mortgage_rates_files/Bank_of_Montreal.xlsx\n",
      "DataFrame 'Scotiabank' has been successfully saved to mortgage_rates_files/Scotiabank.xlsx\n",
      "DataFrame 'CIBC' has been successfully saved to mortgage_rates_files/CIBC.xlsx\n",
      "DataFrame 'National_Bank' has been successfully saved to mortgage_rates_files/National_Bank.xlsx\n"
     ]
    }
   ],
   "source": [
